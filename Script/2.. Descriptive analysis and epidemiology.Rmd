...
Data from round is grouped as following: 

Preliminary: R1, R128, R62, R63, R64, R3, R28, R29, R31, R32, R15, R16, RR and BR
...
Valores_Prel_F_LL <- c(tabla_round_LL["Preliminary", "Yes"],
                      tabla_round_LL["Preliminary", "No"], 
                           tabla_round_LL["Final", "Yes"], tabla_round_LL["Final", "No"])
...
Valores_F_SF_LL <- c(tabla_round_LL["SemiFinal", "Yes"], tabla_round_LL["SemiFinal", "No"], 
                           tabla_round_LL["Final", "Yes"], tabla_round_LL["Final", "No"])
...
Valores_F_QF_LL <- c(tabla_round_LL["QuarterFinal", "Yes"], tabla_round_LL["QuarterFinal", "No"], 
                           tabla_round_LL["Final", "Yes"], tabla_round_LL["Final", "No"])
...
Valores_M_A_LL <- c(tabla_tourney_level_LL["250 or 500", "Yes"], tabla_tourney_level_LL["250 or 500", "No"], tabla_tourney_level_LL["Masters", "Yes"], tabla_tourney_level_LL["Masters", "No"])
...
Valores_M_G_LL <- c(tabla_tourney_level_LL["Grand Slams", "Yes"], tabla_tourney_level_LL["Grand Slams", "No"], tabla_tourney_level_LL["Masters", "Yes"], tabla_tourney_level_LL["Masters", "No"])
epi.2by2(
  dat = Valores_M_G_LL,
  method = "cohort.count", 
  digits = 2, 
...
Valores_M_F_LL <- c(tabla_tourney_level_LL["Tour Finals", "Yes"], tabla_tourney_level_LL["Tour Finals", "No"], tabla_tourney_level_LL["Masters", "Yes"], tabla_tourney_level_LL["Masters", "No"])
epi.2by2(
  dat = Valores_M_F_LL,
  method = "cohort.count", 
  digits = 2, 
...
Valores_Prel_F_PR <- c(tabla_round_PR["Preliminary", "Yes"],
                      tabla_round_PR["Preliminary", "No"], 
                           tabla_round_PR["Final", "Yes"], tabla_round_PR["Final", "No"])
...
Valores_F_SF_PR <- c(tabla_round_PR["SemiFinal", "Yes"], tabla_round_PR["SemiFinal", "No"], 
                           tabla_round_PR["Final", "Yes"], tabla_round_PR["Final", "No"])
...
Valores_F_QF_PR <- c(tabla_round_PR["QuarterFinal", "Yes"], tabla_round_PR["QuarterFinal", "No"], 
                           tabla_round_PR["Final", "Yes"], tabla_round_PR["Final", "No"])
...
Valores_M_A_PR <- c(tabla_tourney_level_PR["250 or 500", "Yes"], tabla_tourney_level_PR["250 or 500", "No"], tabla_tourney_level_PR["Masters", "Yes"], tabla_tourney_level_PR["Masters", "No"])
...
Valores_M_G_PR <- c(tabla_tourney_level_PR["Grand Slams", "Yes"], tabla_tourney_level_PR["Grand Slams", "No"], tabla_tourney_level_PR["Masters", "Yes"], tabla_tourney_level_PR["Masters", "No"])
epi.2by2(
  dat = Valores_M_G_PR ,
  method = "cohort.count", 
  digits = 2, 
...
Valores_M_F_PR <- c(tabla_tourney_level_PR["Tour Finals", "Yes"], tabla_tourney_level_PR["Tour Finals", "No"], tabla_tourney_level_PR["Masters", "Yes"], tabla_tourney_level_PR["Masters", "No"])
epi.2by2(
  dat = Valores_M_F_PR ,
  method = "cohort.count", 
  digits = 2, 
