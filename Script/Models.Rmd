...
data$best_of          <- as.factor(data$best_of)
...
data$best_of      <- relevel(data$best_of, ref = 3)
...
complete_data_LL_validation <- incomplete_data_LL[complete.cases(incomplete_data_LL[, c("tourney_level", "rank_category")]), ]
